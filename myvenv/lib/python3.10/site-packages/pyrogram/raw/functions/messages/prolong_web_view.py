...
class ProlongWebView(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["peer", "bot", "query_id", "silent", "reply_to_msg_id", "send_as"]

    ID = 0xea5fbcce
    QUALNAME = "functions.messages.ProlongWebView"

    def __init__(self, *, peer: "raw.base.InputPeer", bot: "raw.base.InputUser", query_id: int, silent: Optional[bool] = None, reply_to_msg_id: Optional[int] = None, send_as: "raw.base.InputPeer" = None) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "ProlongWebView":
        ...
        return ProlongWebView(peer=peer, bot=bot, query_id=query_id, silent=silent, reply_to_msg_id=reply_to_msg_id, send_as=send_as)
